...
public partial class Main : System.Web.UI.Page
{
    protected void DBInit()   //====自己手寫的程式碼， DataAdapter / DataSet ====(Start)
    {
        ...
        SqlStr = "SELECT a.id,a.lead_reason,a.lead_pno,b.CNAME,b.DEPNAME,a.trsno" +
            ",a.lead_date,a.return_date,a.remarks,a.login_pno,a.login_date " +
            "FROM [CHACC_LIT].[dbo].[lead_trsno4] a,[SCHOOL_LIT].[dbo].[v_linya_peo_test] b " +
            "where a.lead_pno=b.PNO and a.trsno= @trsno and a.return_date is not null;" +
            "SELECT a.id,a.lead_reason,a.lead_pno,b.CNAME,b.DEPNAME,a.trsno" +
            ",a.lead_date,a.return_date,a.remarks,a.login_pno,a.login_date " +
            "FROM [CHACC_LIT].[dbo].[lead_trsno4] a,[SCHOOL_LIT].[dbo].[v_linya_peo_test] b " +
            "where a.lead_pno=b.PNO and a.trsno = @trsno and a.lead_date is not null and a.return_date is null";
    
        SqlCommand cmd = new SqlCommand(SqlStr, Conn);
        cmd.Parameters.AddWithValue("@trsno", DropDownList3.SelectedValue.ToString());
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["CHACC_LITConnectionString"].ConnectionString);
        SqlDataReader dr = null;
        SqlCommand cmd = new SqlCommand("select distinct substring(right(trsno,7),1,2) as month FROM TBTRS where years = '" + DropDownList1.SelectedValue + "' order by month", Conn);
        try
        {
            //== 第一，連結資料庫。
            Conn.Open();   //---- 這時候才連結DB
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["CHACC_LITConnectionString"].ConnectionString);
        SqlDataReader dr = null;
        SqlCommand cmd = new SqlCommand("select trsno+remark as a,trsno FROM TBTRS where years = '" + DropDownList1.SelectedValue + "' and substring(right(trsno,7),1,2)='" + DropDownList2.SelectedValue + "'", Conn);
        try
        {
            //== 第一，連結資料庫。
            Conn.Open();   //---- 這時候才連結DB
            ...
            DropDownList2.DataValueField = "trsno";      //在此輸入的是 test資料表的欄位名稱
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource2.ConnectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["CHACC_LITConnectionString"].ConnectionString;

        //== 撰寫SQL指令(Insert Into) ==
        SqlDataSource2.InsertCommand = "Insert into lead_trsno4(lead_pno,trsno,lead_date,remarks) values('" + TextBox5.Text + "','"+ TextBox6.Text + "','" + TextBox7.Text + "','"+ TextBox8.Text+ "')";
    ...
    protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        SqlDataSource1.UpdateCommand = "update[lead_trsno4] set[lead_pno] = @lead_pno, [lead_date] = @lead_date, [return_date] = @return_date, [remarks] = @remarks where [id] = @id";
    ...
    protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Conn.Open();   //---- 這時候才連結DB
        //== (2). 執行SQL指令。
        SqlCommand cmd = new SqlCommand("delete from [lead_trsno4] where [id] = @id", Conn);
    ...
    protected void DropDownList8_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dr1 = cmd.ExecuteReader();   //---- 這時候執行SQL指令，取出資料
                                         //==第三，自由發揮，把執行後的結果呈現到畫面上。
            DropDownList dp9 = (DropDownList)dp.FindControl("DropDownList9");
            dp9.DataValueField = "PNO";      //在此輸入的是 test資料表的欄位名稱
            dp9.DataTextField = "CNAME";   //在此輸入的是 test資料表的欄位名稱

            dp9.DataSource = dr1;   //-- DropDownList的基本設定，Text與 Value已經在HTML畫面裡設定完成。
            dp9.DataBind();
    ...
    {
        DropDownList dp9 = (DropDownList)sender;
        TextBox tb11 = (TextBox)dp9.FindControl("TextBox11");
        tb11.Text = dp9.SelectedValue.ToString();
    }
